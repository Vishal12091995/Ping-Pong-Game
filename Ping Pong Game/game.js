...
// this is the height and with of window
let windowWidth = window.innerWidth,
    windowHeight = window.innerHeight;


// function calling as the game starts
(function () {
    ...
    resetBoard(rod); //To reset the board
})();
...
function resetBoard(rodName) {
    ...
    rod1.style.left = (window.innerWidth - rod1.offsetWidth) / 2 + 'px'; //Making the Player rod in the center
    rod2.style.left = (window.innerWidth - rod2.offsetWidth) / 2 + 'px';//Making the Player rod in the center
...
// Function the store the value of the winning side
...
// Event keys Game Works on Pressing the key
